...
sudo -u postgres psql tpcds -c "SET CLIENT_ENCODING TO 'latin1'" # may not work. see the fix at the end.


# # load the values
echo 'Loading the values'
...
# # # adding the foreign keys after loading the data
