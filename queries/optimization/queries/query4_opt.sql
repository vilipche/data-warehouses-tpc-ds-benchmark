...
FROM year_store_sales t_s_firstyear
   , year_store_sales t_s_secyear
   , year_catalog_sales t_c_firstyear
   , year_catalog_sales t_c_secyear
   , year_web_sales t_w_firstyear
   , year_web_sales t_w_secyear
